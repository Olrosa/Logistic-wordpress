        ...
        <div class="wrapper">
            <div class="header__offer">
                <a href="/" class="header__logo">
                    <img src="<?php the_field('logo', 2) ?>" alt="logo" class="header__logo-img">
                            ...
                            <div class="flex-offer-col gap-10">
                                ...
                                <div class="flex-offer-col gap-5">
                                    ...
                                    <p class="header__mobile-descr header__mobile-descr-bold">
                                        <?php the_field('timetable', 2) ?>
                                    </p>
                                </div>
                            </div>
                            <a href="tel:<?php the_field('tel', 2) ?>" class="header__tel header__mobile-tel  mob">
                                <?php the_field('tel', 2) ?>
                            </a>
                            <div class="header__social header__mobile-social">
                                <a href="<?php the_field('email', 2) ?>" class="header__social-link">
                                ...
                                <a href="<?php the_field('tg', 2) ?>" class="header__social-link">
                                ...
                                <a href="<?php the_field('wt', 2) ?>" class="header__social-link">
                ...
                <div class="search">
                    ...
                    <a href="tel:<?php the_field('tel', 2) ?>" class="header__tel">
                    <?php the_field('tel', 2) ?>
                    </a>
                    <div class="burger">
                        <span></span>
