...
<section id="hero" class="hero service" style="background-image: url('<?php the_field('hero_bg') ?>');">
    <div class="wrapper">
        <div class="hero__content">
            <div class="flex-offer-col">
                <h1 class="white service__title">
        ...
        <?php echo do_shortcode('[contact-form-7 id="d4035cf" title="Основная форма" html_class="form hero__form form-offer service__form"]') ?>
    </div>
</section>
